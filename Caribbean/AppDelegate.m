...
NSString *const FBSessionStateChangedNotification = @"com.eugenicode.Caribbean:FBSessionStateChangedNotification";
...
- (BOOL)openSessionWithAllowLoginUI:(BOOL)allowLoginUI {
    NSLog(@"openSessionWithAlloLoginUI Called...");
    return [FBSession openActiveSessionWithReadPermissions:nil
                                              allowLoginUI:allowLoginUI
                                         completionHandler:^(FBSession *session,
                                                             FBSessionState state,
                                                             NSError *error) {
                                             NSLog(@"openActiveSessionWithReadPermission completed, session:%@, state: %u", session, state);
